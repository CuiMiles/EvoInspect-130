...
Updated 2026-08-24 18:14 CST. The latest completed evidence consists of a CPU localization
...
- Four seed-130 EfficientAD-S tasks are running on GPUs 4--7; capsule is at
  `epoch=279, global_step=22400`, while wood, transistor, and hazelnut are at
  `epoch=259, global_step=20800`; training processes remain alive with 0 metrics and 0 smoke
  gates so far.
