...
Updated 2026-08-24 18:52 CST. The latest completed evidence consists of a CPU localization
...
- Four seed-130 EfficientAD-S tasks are running on GPUs 4--7; capsule is at
  `epoch=399, global_step=32000`, while hazelnut/transistor/wood are at
  `epoch=379, global_step=30400`; all training processes remain alive with 0 metrics and 0 smoke
  gates so far.
