...
Updated 2026-08-24 18:40 CST. The latest completed evidence consists of a CPU localization
...
- Four seed-130 EfficientAD-S tasks are running on GPUs 4--7; capsule is at
  `epoch=359, global_step=28800`, while hazelnut/transistor/wood are at
  `epoch=339, global_step=27200`; all training processes remain alive with 0 metrics and 0 smoke
  gates so far.
