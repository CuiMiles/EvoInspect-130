...
Updated 2026-08-25 04:13 CST. The latest completed evidence consists of a CPU localization
...
- Seed-130 wood/capsule/transistor/hazelnut completed 4/4 `metrics.json`; the smoke-s131-132 stage
  ...
  transistor-s131/132 are at 17,600 steps and hazelnut-s131/132 at 16,000 steps in the second
  batch.
  `smoke-gate.json`
  is not present yet,
  so no formal
