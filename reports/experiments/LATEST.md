...
Updated 2026-08-24 18:27 CST. The latest completed evidence consists of a CPU localization
...
- Four seed-130 EfficientAD-S tasks are running on GPUs 4--7; capsule is at
  `epoch=319, global_step=25600`, while wood, transistor, and hazelnut are at
  `epoch=299, global_step=24000`; training processes remain alive with 0 metrics and 0 smoke
  gates so far.
