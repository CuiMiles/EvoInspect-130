...
Updated 2026-08-24 23:56 CST. The latest completed evidence consists of a CPU localization
...
- Seed-130 wood/capsule/transistor/hazelnut completed 4/4 `metrics.json`; the smoke-s131-132 stage
  has 8 tasks total, with 4 currently running on GPUs 4--7 (seed-131 latest about 30,400 steps,
  seed-132 about 28,800 steps) and 4 queued. `smoke-gate.json` is not present yet, so no formal
