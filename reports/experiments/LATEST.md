...
Updated 2026-08-25 04:39 CST. The latest completed evidence consists of a CPU localization
...
- Seed-130 wood/capsule/transistor/hazelnut completed 4/4 `metrics.json`; the smoke-s131-132 stage
  ...
  transistor-s131/132 are at 22,400 steps and hazelnut-s131/132 at 20,800 steps in the second
  batch.
  `smoke-gate.json`
  is not present yet,
  so no formal
