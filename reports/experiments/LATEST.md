...
Updated 2026-08-24 19:33 CST. The latest completed evidence consists of a CPU localization
...
- Four seed-130 EfficientAD-S tasks are running on GPUs 4--7; capsule is at
  `epoch=519, global_step=41600`, while hazelnut/transistor/wood are at
  `epoch=499, global_step=40000`; all training processes remain alive with 0 metrics and 0 smoke
  gates so far. GPUs 0--3 are currently occupied by another user and were not touched.
