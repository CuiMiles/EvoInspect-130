...
updated_at: 2026-08-24T20:43:11+08:00
...
- 当前阶段：`wood/capsule/transistor/hazelnut` 四类 seed-130 并行训练，使用 GPU 4--7；
  最新 checkpoint 为 capsule/hazelnut `epoch=719, global_step=57600`，transistor/wood 为
  `epoch=699, global_step=56000`，四个训练进程仍存活；尚无 `metrics.json`、`smoke-gate.json`
