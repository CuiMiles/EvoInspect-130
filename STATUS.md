...
updated_at: 2026-08-24T18:40:46+08:00
...
- 当前阶段：`wood/capsule/transistor/hazelnut` 四类 seed-130 并行训练，使用 GPU 4--7；
  最新 checkpoint 为 capsule `epoch=359, global_step=28800`，hazelnut/transistor/wood 为
  `epoch=339, global_step=27200`，四个训练进程仍存活；尚无 `metrics.json`、`smoke-gate.json`
