...
updated_at: 2026-08-24T17:50:10+08:00
...
- 当前阶段：`wood/capsule/transistor/hazelnut` 四类 seed-130 并行训练，使用 GPU 4--7；
  capsule checkpoint 已到 `epoch=199, global_step=16000`，wood/transistor/hazelnut
  仍为 `epoch=179, global_step=14400`；尚无 `metrics.json`、
