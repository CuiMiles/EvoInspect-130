...
updated_at: 2026-08-24T18:14:58+08:00
...
- 当前阶段：`wood/capsule/transistor/hazelnut` 四类 seed-130 并行训练，使用 GPU 4--7；
  capsule 已到 `epoch=279, global_step=22400`，wood/transistor/hazelnut 为
  `epoch=259, global_step=20800`，训练进程仍存活；尚无 `metrics.json`、
